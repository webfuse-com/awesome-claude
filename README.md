...
- [connerlambden/helium-mcp](https://github.com/connerlambden/helium-mcp) -  Free remote MCP server providing ML-derived options pricing (per-symbol fair value, prob_ITM, Greeks) and 31-dim news bias scoring across 3.2M+ articles. 50 free queries per IP, no signup.
