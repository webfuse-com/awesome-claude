...
- [minia2a/minia2a-mcp](https://github.com/minia2a/minia2a-mcp#readme) -  MCP server connecting AI agents to a live marketplace — discover, trial, and pay for 173+ x402-payable APIs with built-in USDC micropayments.
