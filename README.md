...
- [GolemBot](https://github.com/0xranx/golembot) -  Unified AI assistant framework wrapping Claude Code (+ Cursor, OpenCode, Codex) behind a single API. Features a Skill system, IM channel adapters (Feishu/Slack/Telegram/Discord), fleet mode, and interactive onboard wizard.
