...
- [kodo](https://github.com/ikamensh/kodo#readme) -  Multi-agent orchestrator that wraps Claude Code agents with work cycles and independent verification, improving resolve rates on SWE-bench Verified by 24%.
