...
- [Bernstein](https://github.com/chernistry/bernstein) - Open-source parallel multi-agent orchestrator. Spawns Claude Code, Codex CLI, and Gemini CLI simultaneously on isolated git worktrees, verifies every result with your tests, and auto-commits passing code.
