...
- [Xquik x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) -  X/Twitter automation with MCP server, REST API (121 endpoints), 23 extraction tools, and AI agent skill.
