...
- [fractalmind-ai/agent-manager-skill](https://github.com/fractalmind-ai/agent-manager-skill#readme) — Simple, installation-agnostic agent lifecycle management using tmux + Python.
