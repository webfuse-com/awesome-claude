...
- [Claude Cost Optimizer](https://github.com/Sagargupta16/claude-cost-optimizer) -  Installable cost-mode skill (40-70% token savings) plus 10 optimization guides, Repo Analyzer, templates, and budget hooks. Install: `npx skills add Sagargupta16/claude-cost-optimizer`
