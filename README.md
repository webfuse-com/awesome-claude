...
- [Asqav MCP](https://github.com/jagmarques/asqav-mcp) -  MCP server for AI agent compliance monitoring against EU AI Act and OWASP standards. Tracks compliance scores and generates audit reports.
