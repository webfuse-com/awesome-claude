...
- [shopsavvy/shopsavvy-mcp-server](https://github.com/shopsavvy/shopsavvy-mcp-server#readme) -  MCP server for product lookups, real-time pricing from thousands of retailers, and price history data.
