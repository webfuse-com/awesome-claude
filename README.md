...
- [SkillBoss AI Gateway](https://github.com/heeyo-life/skillboss-mcp#readme) -  Unified API gateway for 100+ AI services (Claude, GPT, Gemini, DALL-E, Midjourney, Runway, ElevenLabs). One API key, OpenAI-compatible.
