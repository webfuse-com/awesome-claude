...
- [Xquik X/Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper#readme) -  Hosted proprietary X/Twitter data extraction MCP server with [remote discovery metadata](https://xquik.com/.well-known/mcp.json), REST API, webhooks, and SDKs; OAuth 2.1 or API key. Not affiliated with X Corp.
